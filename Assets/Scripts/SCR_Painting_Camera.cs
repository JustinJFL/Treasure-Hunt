...
public class SCR_Painting_Camera : MonoBehaviour
{
    //Cameras
    ...
    public GameObject PaintingStealText;
    ...
    void Start()
    {
        ...
        PaintingStealText.SetActive(false);
    ...
    void Update()
    {
        ...
        if (enter == true && Input.GetButtonDown("Steal"))
        {
            Debug.Log("TAKE IT");
            PaintingCanvas.SetActive(false);
            PaintingSignature.SetActive(false);
        }
        ...
        if (enter == true && Input.GetButtonDown("Interact"))
        {
            ...
            PaintingInteractText.SetActive(false);
            PaintingStealText.SetActive(true);
